...
<div class="wrapper">
    <div class="btn">
        <form action="/trash" method="POST">
            @csrf
            <button type="submit" class="custom-btn linkbtn">Trash Table</button>
        </form>
    </div>
    <!-- title-section -->
    <div class="title-container">All Customers</div>
    <!-- table-section -->
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="/delete/{{$c['id']}}" method="POST">
                                @csrf
                                <button type="submit" class="custom-dltbtn dltbtn">Delete</button>
                            </form>
                        </td>
                    </tr>
            </tbody>
